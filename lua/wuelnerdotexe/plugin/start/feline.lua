    ...
    require("feline").setup({
      ...
      custom_providers = {
        aerial_symbols = function()
          ...
          local symbols_path_of_current_location = require("aerial").get_location(true)

          if #symbols_path_of_current_location == 0 then return "..." end

          local symbols = {}

          for _, symbol in pairs(symbols_path_of_current_location) do
            symbols[#symbols + 1] = "%#Aerial" .. symbol.kind .. "Icon#" .. symbol.icon .. " " .. "%*" .. symbol.name
          end
